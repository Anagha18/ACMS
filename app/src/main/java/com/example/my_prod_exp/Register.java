...
public class Register extends AppCompatActivity {
    ...
    String vfullname,vusername,vpassword,vconpassword,vuseremail;
    ...
    private Boolean validate(){
        ...
        vfullname = fullname.getText().toString();
        vusername = username.getText().toString();
        vpassword = userpassword.getText().toString();
        vconpassword = conpassword.getText().toString();
        vuseremail = useremail.getText().toString();
    ...
    private void sendData(){
        ...
        User_Details user_details = new User_Details(vfullname,vusername,vpassword,vuseremail,vconpassword);
