...
public class Reminder extends RecyclerView.Adapter<Reminder.ViewReminder> {
    ArrayList<Dashboard_Remlist> remlistArrayList;

    /*holds the values*/
    public Reminder(ArrayList<Dashboard_Remlist> remlistArrayList) {
    ...
    public void onBindViewHolder(@NonNull ViewReminder holder, int position) {
        ...
        Dashboard_Remlist dashoboard_remlist=remlistArrayList.get(position);
